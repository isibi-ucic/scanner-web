...
function predictWebcam() {
  ...
  if (results.landmarks.length > 0) {
    ...
    // 1. Ambil landmarks dari tangan pertama
    const landmarks = results.landmarks[0];

    // 2. Normalisasi landmarks (SAMA PERSIS SEPERTI DI PYTHON)
    ...
    // 3. Jalankan inferensi dengan model TFLite
    ...
    // Hapus tensor untuk membebaskan memori
    inputTensor.dispose();
    prediction.dispose();
  }
